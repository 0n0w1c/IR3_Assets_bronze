data:extend({
    {
                ...
                layers = {
                    {
                        ...
                        filename =
                        "__IndustrialRevolution3Assets2__/graphics/entities/machines/furnaces/bronze-furnace-base.png",
                        height = 256,
                        priority = "high",
                        repeat_count = 30,
                        scale = 0.5,
                    ...
                    },
                    {
                        ...
                        draw_as_shadow = true,
                        filename =
                        "__IndustrialRevolution3Assets2__/graphics/entities/machines/furnaces/bronze-furnace-shadow.png",
                        height = 192,
                        priority = "high",
                        repeat_count = 30,
                        scale = 0.5,
            ...
            working_visualisations = {
                {
                    animation = {
                        ...
                        draw_as_shadow = false,
                        filename =
                        "__IndustrialRevolution3Assets2__/graphics/entities/machines/furnaces/bronze-furnace-glow.png",
                        frame_count = 30,
                        height = 256,
                        line_length = 5,
                        priority = "high",
        ...
        damaged_trigger_effect = {
            ...
            },
            {
                ...
                probability = 0.23529411764705883,
                repeat_count = 1,
                speed_from_center = 0.02,
                speed_from_center_deviation = 0.01,
                type = "create-particle"
        ...
        dying_explosion = "bronze-furnace-explosion",
        energy_source = {
            type = "burner",
        ...
        icon_size = 64,
        max_health = 325,
        minable = { mining_time = 0.2, result = "bronze-furnace" },
        ...
        placeable_by = { item = "bronze-furnace", count = 1 },
        resistances = {
            {
                percent = 75,
                type = "fire"
